            ...
            <Tabs defaultValue="signin" className="w-full">
              <div className="space-y-6">
                ...
                <div className="min-h-[450px] flex flex-col">
                  <TabsContent value="signin" className="space-y-6 flex-1 data-[state=active]:animate-in data-[state=active]:fade-in-0 data-[state=active]:slide-in-from-right-4 data-[state=inactive]:animate-out data-[state=inactive]:fade-out-0 data-[state=inactive]:slide-out-to-left-4 duration-700 ease-in-out">
                    ...
                    <form onSubmit={handleSignIn} className="space-y-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox id="terms-signin" />
                        <Label htmlFor="terms-signin" className="text-sm text-muted-foreground">
                          I agree to the <button type="button" className="underline hover:text-foreground">Terms & Condition</button>
                        </Label>
                      </div>
                    </form>
                  </TabsContent>
                  
                  <TabsContent value="signup" className="space-y-6 flex-1 data-[state=active]:animate-in data-[state=active]:fade-in-0 data-[state=active]:slide-in-from-left-4 data-[state=inactive]:animate-out data-[state=inactive]:fade-out-0 data-[state=inactive]:slide-out-to-right-4 duration-700 ease-in-out">
                    <div className="text-center space-y-2">
                    ...
                    <form onSubmit={handleSignUp} className="space-y-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox id="terms-signup" />
                        <Label htmlFor="terms-signup" className="text-sm text-muted-foreground">
                          I agree to the <button type="button" className="underline hover:text-foreground">Terms & Condition</button>
                        </Label>
                      </div>
                    </form>
